...
impl TryFrom<igvm_defs::VbsVpContextRegister> for AArch64Register {
    ...
    fn try_from(value: igvm_defs::VbsVpContextRegister) -> Result<Self, Self::Error> {
        ...
        let reg = match HvArm64RegisterName(value.register_name.get()) {
            ...
            HvArm64RegisterName::X2 => Self::X2(register_value.as_u64()),
            HvArm64RegisterName::X3 => Self::X3(register_value.as_u64()),
            HvArm64RegisterName::X4 => Self::X4(register_value.as_u64()),
            HvArm64RegisterName::X5 => Self::X5(register_value.as_u64()),
            HvArm64RegisterName::X6 => Self::X6(register_value.as_u64()),
            HvArm64RegisterName::X7 => Self::X7(register_value.as_u64()),
