...
impl AArch64Register {
    pub fn into_vbs_vp_context_reg(&self, vtl: Vtl) -> VbsVpContextRegister {
        let (register_name, register_value): (_, HvRegisterValue) = match *self {
            ...
            AArch64Register::X8(reg) => (HvArm64RegisterName::X8, reg.into()),
            AArch64Register::X9(reg) => (HvArm64RegisterName::X9, reg.into()),
            AArch64Register::X10(reg) => (HvArm64RegisterName::X10, reg.into()),
            AArch64Register::X11(reg) => (HvArm64RegisterName::X11, reg.into()),
            AArch64Register::X12(reg) => (HvArm64RegisterName::X12, reg.into()),
            AArch64Register::X13(reg) => (HvArm64RegisterName::X13, reg.into()),
            AArch64Register::X14(reg) => (HvArm64RegisterName::X14, reg.into()),
            AArch64Register::X15(reg) => (HvArm64RegisterName::X15, reg.into()),
            AArch64Register::X16(reg) => (HvArm64RegisterName::X16, reg.into()),
            AArch64Register::X17(reg) => (HvArm64RegisterName::X17, reg.into()),
            AArch64Register::X18(reg) => (HvArm64RegisterName::X18, reg.into()),
            AArch64Register::X19(reg) => (HvArm64RegisterName::X19, reg.into()),
            AArch64Register::X20(reg) => (HvArm64RegisterName::X20, reg.into()),
            AArch64Register::X21(reg) => (HvArm64RegisterName::X21, reg.into()),
            AArch64Register::X22(reg) => (HvArm64RegisterName::X22, reg.into()),
            AArch64Register::X23(reg) => (HvArm64RegisterName::X23, reg.into()),
            AArch64Register::X24(reg) => (HvArm64RegisterName::X24, reg.into()),
            AArch64Register::X25(reg) => (HvArm64RegisterName::X25, reg.into()),
            AArch64Register::X26(reg) => (HvArm64RegisterName::X26, reg.into()),
            AArch64Register::X27(reg) => (HvArm64RegisterName::X27, reg.into()),
            AArch64Register::X28(reg) => (HvArm64RegisterName::X28, reg.into()),
            AArch64Register::XFp(reg) => (HvArm64RegisterName::XFp, reg.into()),
            AArch64Register::XLr(reg) => (HvArm64RegisterName::XLr, reg.into()),
            AArch64Register::XSp(reg) => (HvArm64RegisterName::XSp, reg.into()),
...
impl TryFrom<igvm_defs::VbsVpContextRegister> for AArch64Register {
    ...
    fn try_from(value: igvm_defs::VbsVpContextRegister) -> Result<Self, Self::Error> {
        ...
        let reg = match HvArm64RegisterName(value.register_name.get()) {
            ...
            HvArm64RegisterName::X8 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X9 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X10 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X11 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X12 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X13 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X14 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X15 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X16 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X17 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X18 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X19 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X20 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X21 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X22 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X23 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X24 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X25 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X26 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X27 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::X28 => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::XFp => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::XLr => Self::X1(register_value.as_u64()),
            HvArm64RegisterName::XSp => Self::X1(register_value.as_u64()),
